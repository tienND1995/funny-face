       ...
       {isEditing ? (
        <div className='w-full px-4 py-3 bg-white border border-gray-500 rounded-full '>
         <form onSubmit={onSubmitComment} className='flex items-center gap-x-4'>
          ...
          <button className='w-[30px] float-right mr-3' onClick={updateComment}>
        ...
        <div className='w-full px-4 py-3 bg-white border border-gray-500 rounded-2xl'>
         <form onSubmit={onSubmitComment} className='flex items-center gap-x-4'>
          <textarea
          ...
          <div className='flex items-center p-2 gap-x-4'>
           ...
           <button className='w-[30px] h-[30px]' onClick={HandleSendCmt}>
