        ...
        <>
            ...
            <div className="flex justify-center items-start h-full relative">
                ...
                <div className="absolute bottom-0 left-0 text-gray-800 p-4">
                    <h1 className="font-serif font-semibold" style={{ fontSize: '3em' }}>A.I Video</h1>
                    <p className="font-serif font-semibold" style={{ fontSize: '2em' }}>Predict the future of your journey and love</p>
                </div>
            </div>
            <div className="bg-no-repeat bg-cover">
                <p className="font-serif font-medium p-9 italic" style={{ fontSize: '3em' }}>Original video archive :</p>
