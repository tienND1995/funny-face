...
function Video() {
  ...
  useEffect(() => {
    axios
      .get(`https://metatechvn.store/lovehistory/video/${count}`, {
        headers: {
  ...
  return (
    ...
    >
      ...
      <div className="video-container">
        <p
          className="font-serif font-medium p-9 italic text-white"
          style={{ fontSize: "3em" }}
        >
          Results video
        </p>
        {video &&
          video.list_sukien_video.map((v) => (
            <Link to={`/detailVideo/${v.sukien_video[0].id_video}`}>
              <div
                className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 inline-block border border-gray-300 rounded-lg shadow-lg text-center"
              ...
              >
                ...
                <div className="uppercase text-white tracking-wide text-sm font-semibold">
